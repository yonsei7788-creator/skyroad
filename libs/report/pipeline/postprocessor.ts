...
const AI_TONE_REPLACEMENTS: [RegExp, string][] = [
  ...
  [/것으로 평가됩니다/g, "라고 봅니다"],
  [/것으로 사료됩니다/g, "라고 봅니다"],
  [/것으로 예상됩니다/g, "것으로 보입니다"],
  [/판단됩니다/g, "봅니다"],
  [/평가됩니다/g, "봅니다"],

  // ── "~을 보여줍니다/드러냅니다/나타냅니다" → 직접 서술 ──
  [/을 보여주고 있습니다/g, "이 확인됩니다"],
  [/를 보여주고 있습니다/g, "가 확인됩니다"],
  [/을 보여줍니다/g, "이 확인됩니다"],
  [/를 보여줍니다/g, "가 확인됩니다"],
  [/이 드러납니다/g, "이 확인됩니다"],
  [/가 드러납니다/g, "가 확인됩니다"],
  ...
  [/불리할 수 있습니다/g, "불리합니다"],
  [/유리할 수 있습니다/g, "유리합니다"],
  [/약점이 될 수 있습니다/g, "약점입니다"],
  [/강점이 될 수 있습니다/g, "강점입니다"],
  [/감점 요인이 될 수 있습니다/g, "감점 요인입니다"],
  [/어필할 수 있습니다/g, "어필 포인트입니다"],

  // ── "~을 가지고 있습니다" → 간결 ──
  [/경쟁력을 가지고 있습니다/g, "경쟁력이 있습니다"],
  [/경쟁력을 가집니다/g, "경쟁력이 있습니다"],
  [/가능성을 가지고 있습니다/g, "가능성이 있습니다"],
  [/가능성을 가집니다/g, "가능성이 있습니다"],

  // ── "~것이 중요합니다/필요합니다" → 직접 조언 ──
  [/것이 중요합니다/g, "게 중요합니다"],
  [/것이 필요합니다/g, "게 필요합니다"],
  [/하는 것이 바람직합니다/g, "하는 게 좋겠습니다"],
  [/것이 바람직합니다/g, "게 좋겠습니다"],
  ...
  // ── 기타 AI식 표현 ──
  [/깊이 있는 탐구 활동을 통해/g, "탐구 활동을 바탕으로"],
  [/다양한 활동을 통해/g, "활동을 통해"],
  [/적극적으로 참여하며/g, "참여하며"],
  [/지속적으로 발목을 잡을/g, "발목을 잡을"],
];
