...
- 5등급제 내신 평균 1.33 = 9등급제 2.0 → 학업성취도 36~40점
- 5등급제 내신 평균 1.89 = 9등급제 3.0 → 학업성취도 28~35점
- 5등급제 내신 평균 2.43 = 9등급제 4.0 → 학업성취도 20~27점
- 5등급제 내신 평균 3.03 = 9등급제 5.0 → 학업성취도 12~19점
- ⚠️ 5등급제 2등급(평균 1.33~1.89)은 9등급제 2~3등급 수준입니다. 9등급제 2등급과 동일하게 채점하면 안 됩니다.

### 교과성취도(진로역량) 채점 보정
- 5등급제 기준 교과성취도 점수 배분 (정밀 환산표 적용):
  - 평균 ~1.33 이하(=9등급 2.0 이하) → 27~30점
  - 평균 1.33~1.89(=9등급 2.0~3.0) → 21~26점
  - 평균 1.89~2.43(=9등급 3.0~4.0) → 15~20점
  - 평균 2.43~3.03(=9등급 4.0~5.0) → 8~14점
  - 평균 3.03 초과(=9등급 5.0 초과) → 0~7점
...
- 위 환산표는 **점수 산출용 내부 참조**입니다. comment에 "9등급제 환산 시 X등급", "9등급제 X등급 수준으로" 등 **9등급제 관련 표현을 절대 사용하지 마세요.**
- ❌ "내신 평균 2.23등급(5등급제)으로 9등급제 환산 시 3.5등급 수준입니다"
- ❌ "(9등급제 3.5등급 수준으로 -12점)"
- ✅ "내신 평균 2.23등급(5등급제)으로, 5등급제 기준 중상위권입니다. (-12점)"
- ✅ "5등급제 2.23등급은 상위 34%~66% 구간으로, 주요 과목 2등급 유지가 강점입니다. (-12점)"
- comment에는 5등급제 등급과 비율(상위 N%)만 사용하세요.
...
${
  input.gradingSystem === "5등급제"
    ? `- 학업성취도(38/40): "내신 평균 1.2등급(5등급제), 국수영 전과목 1등급 유지. 화학 2등급 등 일부 과목 편차로 -2점."
- 교과이수노력(22/30): "대수/기하/미적분Ⅰ 이수로 기본 요건 충족. 미적분Ⅱ·인공지능수학 미이수로 핵심 권장과목 50% 미달, -8점."`
