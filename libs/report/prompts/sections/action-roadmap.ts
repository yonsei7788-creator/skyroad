...
## ⛔⛔⛔ 이수 완료 과목 성적 개선 절대 금지 (최우선 규칙)
- "이수 완료 과목 정보"에 나열된 과목(진로선택 포함)은 성적이 확정되어 재이수 불가능합니다.
- phases의 **goals와 tasks 모두**에서 이수 완료 과목의 성적/성취도 향상을 제시하면 안 됩니다.
- ❌ "정보 과목 성취도 개선" (1학년에 이미 이수 완료 → 2학년에 재이수 불가)
- ❌ "정보 과목 수업에 적극 참여하고" (이미 이수 완료된 과목 → 2학년에 수업 없음)
- ✅ "2학년 진로선택과목에서 A/B 성취도 확보" (구체적 과목명은 아직 이수하지 않은 과목으로)
- ✅ "정보 교과에서 부족했던 역량을 동아리 활동이나 다른 교과 세특으로 보완" (과목 재이수가 아닌 우회 보완)
