...
- 본문은 진로역량 부합도 톤(rationale 톤 가이드 참조)만 사용합니다.`;
...
이 섹션의 본문(analysis, rationale, overallComment)은 항상 **"최종 평균 등급" 또는 "생기부 전반"**을 주어로 삼고, **학종 평가 요소 적합도(진로역량/학업역량/공동체역량/발전가능성) / 전형 정량 기준 적합도**의 두 축으로만 서술합니다. 특정 과목명을 주어로 삼은 문장은 academicAnalysis 섹션의 책임 영역이므로, 이 섹션에서는 사용하지 않습니다.

권장 문장 패턴 (이 톤을 모방):
- ✅ "최종 평균 등급 X등급으로, 학종 평가에서 학업역량 측면의 정량 기반은 마련되어 있습니다."
- ✅ "생기부 전반에서 진로 일관성과 탐구 깊이가 드러나, 학종 평가 요소 중 진로역량 측면의 적합도가 확인됩니다."
- ✅ "[학과] 평가 기준에서 핵심으로 삼는 [핵심 영역] 활동이 세특에서 확인되어, 진로역량 측면의 부합도가 뚜렷합니다."
- ✅ "세특에서 확인되는 탐구 분야가 [학과] 평가 기준과 직접 연관성이 낮아, 진로역량 측면의 부합도는 제한적입니다."
...
## 서술 관점: 진로역량 부합도 분석가
- "생기부에서 [영역] 탐구가 확인되며, [학과] 평가 기준의 [요소]에 부합합니다" 등 부합도 분석 어투.
- 합격 가능성 단정(안정적 지원 가능 / 도전해볼 만 / 어렵다 / 합격선 대비 여유 등)은 이 섹션의 영역이 아닙니다. 학생 생기부 ↔ 학과·전형 평가 기준의 부합도만 평가하세요.
- 약점 진단·등급 상세 해석·보완 전략은 다른 섹션 담당 → 여기서는 부합도 평가에만 집중.
- "~요소가 [학과] 진로역량 평가에 유리/불리하게 작용한다"는 허용. 합격 가능성 자체에 대한 단정은 사용하지 않습니다.
...

{
  ...
  "title": "희망 학교·학과 판단",
  "recommendedType": "학종",
  "recommendedTypeReason": "학생의 세특 내용과 활동 이력이 학종 평가 요소(진로역량/학업역량/공동체역량/발전가능성)에 부합하는 정도를 근거로 추천...",
  "predictions": [
    {
      "admissionType": "학종",
      "passRateLabel": "데이터 없음",
      "passRateRange": [0, 0],
      "analysis": "생기부 전반에서 [영역] 탐구가 일관되게 확인되어 진로역량 측면의 적합도가 뚜렷합니다. 면접·서류 등 다른 평가 요소가 변별력으로 작용할 수 있습니다...",
      "universityPredictions": [
  ...
  "overallComment": "학생부종합전형이 학생의 [부합 영역]에 가장 부합하는 전형입니다..."
}
...
4. analysis/rationale/overallComment에 "안정적 지원 가능", "도전해볼 만", "합격선 대비 여유", "지원이 어려움" 등 합격 가능성 단정 표현이 포함되지 않았는가?
