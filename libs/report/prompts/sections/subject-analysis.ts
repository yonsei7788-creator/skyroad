...
## 비핵심 과목 중요도 규칙 (필수)
- 정보, 제2외국어(일본어, 중국어 등), 기술·가정: 중요도 5% 이하, 평가 영향도 "낮음"으로 설정
- 이 과목들은 학종 평가에서 성실성 확인 수준이며, 핵심 평가 대상이 아닙니다.

## 전공별 과목 중요도 조정 규칙 (필수)
- 이공계(컴퓨터공학, 전자공학, 기계공학 등) 지망 학생:
  - 물리학, 기하: 중요도 30~40%, 평가 영향도 "매우 높음"
  - 과학탐구실험: 중요도 10% 이하, 평가 영향도 "보통"
  - 통합과학: 중요도 15% 이하, 평가 영향도 "보통"
  - 세계지리, 한국지리 등 사회탐구: 중요도 10% 이하, 평가 영향도 "낮음"
- 인문·사회계열 지망 학생:
  - 사회·문화, 정치와법, 경제: 중요도 25~35%, 평가 영향도 "높음" 또는 "매우 높음"
  - 과학탐구실험, 통합과학: 중요도 10% 이하, 평가 영향도 "낮음"
