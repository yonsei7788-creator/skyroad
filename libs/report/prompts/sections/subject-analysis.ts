...
⚠️ **절대 선택하면 안 되는 과목**: 독서, 기술·가정, 제2외국어(일본어·중국어·독일어 등), 정보, 한문, 교양, 보건, 체육, 음악, 미술. 이 과목들은 학종 핵심 평가 대상이 아니므로 5개 안에 절대 포함하지 마세요.
⚠️ **정보 과목 유일한 예외**: 컴퓨터공학, 소프트웨어공학, 정보보안 등 CS 전공 지망 학생만 "정보"를 포함. 의대, 자연과학, 일반 공학 등은 정보 과목을 포함하지 마세요.
...
## 비핵심 과목 중요도 규칙 (최우선 — 반드시 준수)
- **제2외국어**(일본어, 중국어, 독일어, 프랑스어, 스페인어 등), **정보**, 기술·가정, 독서, 한문, 교양, 보건, 체육, 음악, 미술: **중요도 5% 이하, evaluationImpact: "low" 또는 "very_low"**
- 이 과목들은 학종 평가에서 성실성 확인 수준이며, **핵심 평가 대상이 절대 아닙니다.**
- evaluationComment, detailedEvaluation 등 텍스트에서도 이 과목들을 "핵심 과목", "전공 관련 과목", "중요한 과목"으로 서술하면 안 됩니다. "부수적 과목", "성실성 확인용" 정도로만 언급하세요.
- ⚠️ **정보 과목 유일한 예외**: 컴퓨터공학, 소프트웨어공학, 정보보안 등 **CS 전공 지망 학생에 한해서만** 중요도 30~40%. 그 외 모든 학과(의대, 자연과학, 공학 포함)에서 정보 과목은 **5% 이하**입니다.
- ⚠️ **제2외국어는 어떤 학과든 중요도 5% 이하입니다.** 외국어 관련 학과(영문과, 불문과 등)라 해도 제2외국어 세특의 입시 변별력은 매우 낮습니다.
