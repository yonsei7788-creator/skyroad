...
- excellent/good/average rating에서는 "보완이 필요한 부분입니다", "강화 여지가 있습니다", "더 깊이 있는 ~이 필요합니다" 같은 **보완 가능한 톤**을 사용합니다.
- "약점으로 작용할 겁니다", "변별력이 부족하다고 판단할 수 있습니다", "한계가 있습니다" 같은 **단정적 부정 톤은 weak rating에서만** 사용하세요. average 이상 rating에서는 사용하지 않습니다.
- ✅ average 예시: "...수학 신문 제작 등 자기주도성이 보이며, 다만 수학적 사고의 깊이는 보완이 필요한 부분입니다."
- ❌ average인데 단정 부정: "...이는 학종에서 약점으로 작용할 겁니다." (rating과 톤 불일치)`,
  standard: `## 분석 수준: 상세
### 과목 분류 및 분석 범위
