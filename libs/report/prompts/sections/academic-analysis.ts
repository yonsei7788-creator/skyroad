...
- 해석 (interpretation): **최종 평균 등급이 교과전형 합격선 대비 어디에 위치하는지만** 서술.
  ...
  - ❌ "지원 반영 과목을 확인하고, 해당 과목에서 최상위 등급을 목표" — 특정 과목 활용 금지

## 출력 전 자기 검증 (교과전형 필수)
1. interpretation에 "하락", "상승", "추세", "추이", "변화" 단어가 포함되지 않았는가? → 있으면 삭제하고 최종 등급 비교로 대체
2. "반영 과목", "강점 과목", "특정 과목" 표현이 포함되지 않았는가? → 있으면 삭제
