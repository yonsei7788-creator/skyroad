...
- admissionStrategy: **500자 이내**. ${isGyogwaOnly ? "교과전형 중심의 합격 가능성 분석. ⚠️ 합격 예측 결과(admissionPrediction)가 제공된 경우, 그 결과의 chance/passRateRange와 일관되게 서술하세요. 최종 평균 등급과 합격선 대비 위치만 분석하세요. 상향/안정/하향 배치 방향." : "교과/학종 각각의 가능성 분석. ⚠️ 합격 예측 결과(admissionPrediction)가 제공된 경우, 그 결과의 chance/passRateRange와 일관되게 서술하세요. 6장 카드 조합 시뮬레이션, 상향/안정/하향 배치 방향."}
...
${input.preprocessedAcademicData ? `### 성적 원본 데이터 (코드 계산 완료 — 등급 인용 시 반드시 이 데이터 기준)\n${input.preprocessedAcademicData}\n\n⚠️ 과목별 등급을 언급할 때는 반드시 위 원본 데이터의 수치를 확인하세요. "성적 분석 결과"의 해석 텍스트가 아닌, 이 원본 데이터가 정확한 등급입니다.` : ""}
...
- courseEffort: **500자 이내**. 핵심/권장 과목별 이수 노력 상세 평가, 전공 관련 교과 선택의 적합성 분석, 소인수 과목 전략, 진로선택과목 성취도 해석.
- admissionStrategy: **500자 이내**. 교과전형 중심의 합격 가능성 분석. 최종 평균 등급과 합격선 대비 위치만 분석하세요. 상향/안정/하향 배치 방향.
