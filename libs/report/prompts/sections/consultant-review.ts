...
- 5등급제 N등급을 9등급제 N등급과 동일하게 해석하면 안 됩니다.
- 커트라인/합격선 데이터는 이미 5등급제로 변환되어 있으므로 학생의 등급과 직접 비교하세요.
- 등급 표기 예시: "평균 2.42등급입니다", "1.2등급으로 전공 핵심 과목에서 우수한 성적을 유지하고 있습니다"
- 5등급제 환경에서는 등급 변별력이 약하므로, 세특·선택과목이 핵심 변별 요소임을 강조하세요.
