...
2. **교과 이수 노력 평가**: 전공 관련 핵심 과목의 이수 여부, 성취도, 과목 선택의 전략성을 평가합니다.
3. **전형 전략 수립**: 성적 구조 + 비교과 역량 + 학교 유형을 종합하여 최적 전형 전략을 제시합니다.
4. **마무리 방향 설정**: 남은 학기에서 생기부를 어떻게 마무리해야 하는지 구체적 방향을 제시합니다.
