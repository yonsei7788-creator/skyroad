...
## ⚠️ 분석 방향 원칙
⚠️ 시스템 프롬프트의 "생기부 기반 분석 / 희망학과 끼워맞추기 금지" 원칙을 이 섹션에 반드시 적용하세요.
...
### ⚠️ 실기 비중이 절대적인 학과 추천 시그널 요건 (필수)
아래 학과들은 입시에서 학과 고유의 실기·실연이 합격을 좌우하는 영역입니다. 학생 생기부에 **해당 학과 고유 실기 시그널이 3건 이상 명시되어 있을 때만** 추천 후보에 포함합니다.

| 학과군 | 추천 가능 시그널 (생기부 기록 기준) |
|--------|--------------------------------------|
| 연극영화·영화·연극·공연예술학과 | 연기 활동 / 영상 연출·제작 / 시나리오 집필 / 영화·연극 비평·평론 동아리 |
| 실용음악·작곡·음악학과 | 밴드·공연 활동 / 작곡 작품 / 보컬·악기 연주 / 음악 동아리 활동 |
| 무용학과 | 무용 작품·안무 활동 / 무용 동아리·실기 경험 |
| 체육교육·체육·스포츠과학과 | 운동 종목 실기 / 스포츠 분석 탐구 / 체육 동아리·대회 활동 |
| 미술실기 학과 (회화·조소·동양화·서양화·한국화) | 실기 작품 포트폴리오 / 미술 실기 입상 / 미술 실기 동아리 |
| 국악과 | 국악기 연주 / 국악 공연 / 국악 동아리 활동 |

**자기검증 규칙 (필수)**: 추천하려는 실기 학과에서 gapAnalysis 문장이 학과의 핵심 실기 영역(연기·연출·작곡·연주·무용 작품·실기 포트폴리오 등)이 부족하다는 내용을 담게 된다면, 그 매칭은 학과 적합도가 충분하지 않다는 신호입니다. 이 경우 추천을 **비실기·이론 비중이 큰 인접 학과**로 대체합니다.

**시각예술 활동 학생 매칭 가이드 (Positive 매핑)**:
시각디자인·포스터·공익광고 시각화·미술 프로젝트·머그컵/굿즈 디자인 등 **시각예술 활동이 강점인 학생**은 다음 인접 학과를 추천 후보로 선정합니다.
- 시각디자인학과 / 산업디자인학과 / 미디어디자인학과 / 디자인공학과
- 문화콘텐츠학과 / 미디어커뮤니케이션학과 / 광고홍보학과 / 콘텐츠학부

위 인접 학과들은 실기 입시 비중이 낮거나 포트폴리오·자기소개서·서류 평가 비중이 높아, 시각예술 활동 시그널을 정량 적합도로 환산하기에 적합합니다. 연극영화·연기·무용·실용음악·국악·미술실기 학과는 위 표의 학과별 시그널이 따로 확인될 때만 추천합니다.
...
- 예: "수학 심화 탐구 비중이 낮아 학과 핵심 역량 증거가 제한적입니다." (사실 진술)
- ❌ 금지: "남은 학기에서 ~ 선택과목을 이수하면 전공 적합성을 보완할 수 있습니다."
`
    : ""
}
