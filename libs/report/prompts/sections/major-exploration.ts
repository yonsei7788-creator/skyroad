...
**⚠️ currentTargetAssessment 표현 강도 규칙 (필수):**
목표 학과의 적합도에 따라 표현 강도를 반드시 아래 기준으로 작성하세요:
- 세특에서 목표 학과 관련 심화 탐구 3건 이상 → "부합합니다", "적합합니다"
- 세특에서 관련 탐구 2건 + 교과 부분 일치 → "부분적으로 연관됩니다", "일부 연관성이 있습니다"
- 관련 탐구 1건 이하 또는 깊이 부족 → "적합하지 않습니다", "연관성이 부족합니다"
- ❌ 근거가 부족한데 "적정 수준이다", "무난하다", "괜찮다"로 마무리 금지
- ❌ "~이지만 가능성은 있다" — 적합도가 낮으면 가능성 언급 금지
