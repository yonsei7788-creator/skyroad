...
"의생명"은 다른 계열보다 오판(과대 분류)이 가장 흔하게 발생합니다. "질병", "치료", "의학적", "임상", "환자" 같은 단어가 세특에 등장한다고 자동으로 "의생명"을 선택하지 마세요 — 이 단어들은 "생명과학"·"바이오"·"약학" 탐구에서도 흔히 등장합니다. "의생명"을 선택하려면 아래 중 **최소 하나**가 명확히 확인되어야 합니다:
...
위 1, 2 중 어느 것도 명확하지 않다면 — 세특이 질병 기전, 유전자, 약물, 진단 원리를 다루더라도 — 그건 "연구·기술 탐구"이지 "임상 지향"이 아닙니다. 이 경우 탐구 내용에 따라 "생명과학"(생명현상 자체 연구), "바이오"(생명공학 기술 응용), "약학"(신약·약물 개발) 중 하나로 판단하세요.
...
⚠️ "생명과학"/"바이오"와 "의생명"/"약학"도 혼동하지 마세요. 희망분야에 "의예과"/"의학"/"약학"이 적혀 있어도, 세특 탐구가 아래에 해당하면 반드시 "생명과학" 또는 "바이오"로 판단하세요:
  - 생명과학: 생명현상 자체의 원리 규명이 목적 (세포, 유전, 생태, 미생물, 해부·생리 등 탐구). 환자·질병 치료가 아니라 생물학적 메커니즘 자체를 다룸. 예: "초파리 교배 실험으로 유전 법칙 검증", "하천 생태계 먹이사슬 조사", "미생물 배양·관찰 실험".
  - 바이오: 생명과학 원리를 기술/산업에 응용하는 탐구 (유전공학, 발효공학, 바이오소재, 생명공학 기술 구현)가 주력. 예: "CRISPR 유전자 가위 원리 탐구 및 편집 실습", "미생물 발효를 이용한 바이오플라스틱 합성 실험".
  → 세특에서 환자 사례·임상 연구·질병 진단/치료가 주력이 아니라 생명현상 탐구나 생명공학 기술 응용이 주력이면, 희망학과 명칭이 "의예과"여도 "생명과학" 또는 "바이오"로 판단하세요. 희망학과 명칭만 보고 "의생명"을 선택하지 마세요.
