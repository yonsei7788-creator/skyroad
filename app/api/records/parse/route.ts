...
생기부 출결 테이블의 컬럼 순서:
학년 | 수업일수 | 결석일수(질병,미인정,기타) | 지각(질병,미인정,기타) | 조퇴(질병,미인정,기타) | 결과(질병,미인정,기타) | 특기사항

필드 매핑:
- 결석일수-질병 → "absenceIllness"
- 결석일수-미인정 → "absenceUnauthorized"
- 결석일수-기타 → "absenceOther"
...
예시: 1학년 결석일수-질병=2, 2학년 지각-질병=4 이면:
[
  { "year": 1, "totalDays": 190, "absenceIllness": 2, "latenessIllness": null, ... },
  { "year": 2, "totalDays": 191, "absenceIllness": null, "latenessIllness": 4, ... }
]
"결석일수" 열의 숫자는 반드시 absence 필드에, "지각" 열의 숫자는 반드시 lateness 필드에 넣으세요. 절대 혼동하지 마세요.
  ...
  "attendance": [
    {
      ...
      "absenceIllness": number|null,         // 결석일수-질병
      "absenceUnauthorized": number|null,    // 결석일수-미인정
      "absenceOther": number|null,           // 결석일수-기타
      "latenessIllness": number|null,        // 지각-질병
      "latenessUnauthorized": number|null,   // 지각-미인정
      "latenessOther": number|null,          // 지각-기타
      "earlyLeaveIllness": number|null,      // 조퇴-질병
      "earlyLeaveUnauthorized": number|null, // 조퇴-미인정
      "earlyLeaveOther": number|null,        // 조퇴-기타
      "classMissedIllness": number|null,     // 결과-질병
      "classMissedUnauthorized": number|null,// 결과-미인정
      "classMissedOther": number|null,       // 결과-기타
      "note": string                         // 특기사항
    }
  ],
  "awards": [
